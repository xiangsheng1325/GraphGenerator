...
// ROK 2012/08/15 PNGraph GetSubGraph is not documented by doxygen.
...
// ROK 2012/08/15 PGraph GetESubGraph TIntPrV is not documented by doxygen.
...
// RS 2012/08/14 find out why TSnap::ConvertSubGraph<PUNGraph>(NGraph, NIdV, true) aborts
